...
def site_generate_cst_file(site_pose, output_file, specified_residues):
    ...
    # Generate constraints between ligand and specified residues
    template_sections = \
'''CST::BEGIN
...
CST::END'''
    ...
    for pro_res in specified_residues:
...
def translate_binding_site(binding_site_pdb,output_path):

    site_pose = pyrosetta.pose_from_file(binding_site_pdb) 

    generate_cst_file(site_pose, output_path)
