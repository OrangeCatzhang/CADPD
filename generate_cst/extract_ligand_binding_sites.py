...
def generate_params_file_for_ligand(ligand_pdb, ligand_name, ligand_id, output_path):
    ...
    with open('/home/bio/workshop/Zpinyang/match_ligand_binding_sites-main/site_settings.json', 'r') as f:
...
def get_cst(input_path,output_path):



   

    get_binding_sites_for_a_structure(input_path, output_path)
